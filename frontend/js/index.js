...
//FUNCTIONS TO FILL IN THE CONTACT TABLE
...
async function fillContacts(){
    try {
        ...
        //Function to start the data table library
        ...
        //Setting datatable for search bar
...
//Disable-Enable WhatsApp / Facebook / Twitter Select Preferences
...
$('#add_contact').on('hidden.bs.modal', () => {
    ...
    $('#body_modal').append(`<div class="row">
                                ...
                                <div class="col-4">
                                    ...
                                    <input type="text" class="form-control" id="contact_email" placeholder="email@email.com">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-3">
                                    ...
                                    <input type="number" class="form-control" id="channel_user_w" placeholder="+5492932415173">
                                </div>
                                <div class="col-3">
...
//FUNCTIONS OF THE COMPANIES SECTION
//FUNCTIONS TO FILL IN THE TABLE IN COMPANIES
...
//FUNCTIONS OF THE REGION-CITY SECTION
//JSTREE FUNCTIONS
...
//FUNCTIONS TO DELETE REGION / CITY
...
//BTN Dropdown for Country - MODAL Set
...
//BTN Dropdown for City - MODAL Set
...
//FUNCTIONS OF THE USERS SECTION
