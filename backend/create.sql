...
VALUES ('BYC', 'xxxxxx', 'byc@byc.com.ar', '+54929322222', 'Buenos Aires', 13),
('Globant', 'xxxxxx', 'globant@globant.com.ar', '+54929322222', 'Buenos Aires', 1),
('Globo', 'xxxxxx', 'globo@globo.com.ar', '+549293222221', 'Buenos Aires', 5),
('MercadoLibre', 'xxxxxx', 'mercadolibre@mercadolibre.com.ar', '+54929322222', 'Córdoba', 2);
...
VALUES ('1', 'Whatsapp', '+54929322222', 'No molestar'),
('1', 'Facebook', 'FbICa', 'Canal favorito'),
('1', 'Twitter', 'FbICa', 'Sin preferencia'),
('2', 'Whatsapp', '', ''),
('2', 'Facebook', '', ''),
('2', 'Twitter', 'Irian', 'Sin preferencia'),
('3', 'Whatsapp', '+54929322222', 'Sin preferencia'),
('3', 'Facebook', '@Fb', 'No molestar'),
('3', 'Twitter', '@Fb', 'Canal favorito'),
('4', 'Whatsapp', '+54929322222', 'Sin preferencia'),
('4', 'Facebook', '', ''),
('4', 'Twitter', '', ''),
('5', 'Whatsapp', '+54929322222', 'Sin preferencia'),
('5', 'Facebook', 'sFb', 'No molestar'),
('5', 'Twitter', 'twitt', 'Canal favorito'),
('6', 'Whatsapp', '', 'Sin preferencia'),
('6', 'Facebook', 'Noice', 'No molestar'),
('6', 'Twitter', 'Genius', 'Canal favorito'),
('7', 'Whatsapp', '+54929322222', 'Canal favorito'),
('7', 'Facebook', 'ART', 'No molestar'),
('7', 'Twitter', 'ET', 'Sin preferencia'),
('8', 'Whatsapp', '', 'Sin preferencia'),
('8', 'Facebook', '', 'Sin preferencia'),
('8', 'Twitter', 'SocUB', 'Canal favorito'),
('9', 'Whatsapp', '', 'Sin preferencia'),
('9', 'Facebook', '', 'Sin preferencia'),
('9', 'Twitter', '', 'Sin preferencia'),
('10', 'Whatsapp', '+54929322222', 'Canal favorito'),
('10', 'Facebook', '', ''),
('10', 'Twitter', '', '')
;
